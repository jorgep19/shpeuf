	...
	companiesData['BA'] = {
		...
		facts: "-Boeing is the prime contractor for the International Space Station-Boeing forecasts a long-term demand for 34,000 new airplanes-170,000 Employees-68 percent of new deliveries will be single-aisle airplanes, reflecting growth in emerging markets, such as China, and the continued expansion of low-cost carriers throughout the world.",
		linkedin: " ",
		twitterlink: "@Boeing",
	...
	companiesData['BAH'] = {
		...
		facts: "-2012 earnings: $5.86 billion -25,000 employees-Named by Fortune magazine to its list of the “World’s Most Admired Companies” (2012)\n-Edwin G. Booz developed the profession management consulting-The firm has gone through several name changes is its near-100 years of existence. ",
		linkedin: " ",
	...
	companiesData['BSX'] = {
		...
		facts: "-$895 Million invested in Research & Development in 2011 -$7.6 Billion Revenue (2011)\n-One of the world's largest medical device companies",
		linkedin: " ",
	...
	companiesData['CLX'] = {
		...
		founded: "1913 Oakland, California",
		slogan: "\"We Make Everyday Life Better, Every Day\"",
		facts: "-2012 earnings: $5.5 billion - Number of employees: 8,400 worldwide - Markets in 100+ countries",
		linkedin: "",
		twitterlink: "@Clorox",
		fblink: "Clorox",
		rssfeed: "",
		lookfor: "No specified fields in engineering/ variety of disciplines",
		overview: "Clorox is a global company that manufactures a variety of consumer goods: bleach and cleaning products, cat litter, charcoal, dressings and sauces, water filtration products, Glad bags, and natural personal care products.",
		mission: "Clorox strives to make everyday life better by giving back to communities. Whether it's contributing to disaster relief efforts through donations of Clorox® regular bleach, teaching classes at local schools or funding education, arts and culture programs, Clorox is committed to help restore, enrich and protect the communities in which it does business.",
		goals: "To understand and delight consumers with brands that enhance their lives, as well as to make a positive impact in the communities where they do business.",
		businessModel: "- Do the Right Thing- emphasis on integrity and open communication to consumers and workers - Stretch for Results- to continue to have success and dominate in the markets where they manufacture goods - Take Personal Ownership- everyone has a responsibility in helping with the progress of the company, and ensuring their goals are acheived - Work Together to Win- teamwork is important for success",
		applylink: "http://bit.ly/PyET62",
		news: "",
	...
	companiesData['CGSM'] = {
		...
		id: "CGSM",
		logo: "CGSM.png",
		industries: "Non-profit Organization Promoting Diversity",
		founded: "1965",
		slogan: "\"Diversity is an American opportunity-not a legal or political issue\"",
		facts: "- The consortium has increased the number of annual fellowships awarded from 21 to over 350. -Fellowships are funded by a variety of top American businesses and universities.",
		linkedin: "",
		twitterlink: "@cgsm_mba",
		fblink: "http://on.fb.me/UiqVqp",
		rssfeed: "",
		lookfor: "All engineering majors",
		overview: "The Consortium for Graduate Study in Management is the country’s preeminent organization for promoting diversity and inclusion in American business.",
		mission: "The mission of The Consortium for Graduate Study in Management is to enhance diversity in business education and leadership by helping to reduce the serious underrepresenting of African Americans, Hispanic Americans, and Native Americans in both member schools’ enrollments and the ranks of management.",
		goals: "The vision of The Consortium is to work toward the day when African Americans, Hispanic American, and Native Americans are no longer underrepresented in management careers in business.",
		businessModel: "Through an annual competition, The Consortium awards merit-based, full-tuition fellowships to America’s best and brightest candidates. In conjunction with member schools, sponsoring companies, and elite groups of MBA students and alumni, The Consortium has built a 44 year legacy of fostering inclusion and changing the ethnic and cultural face of American business.",
		applylink: "http://bit.ly/b30Yp",
		news: "",
	...
	companiesData['CONTI'] = {
		...
		facts: "- Ranked #1 in NJ Top Construction Firms   - Conti also works on wind farm projects and solar power projects.   - CEO and President is Kurt Conti, who won the 2012 Ernst & Young Entrepreneur of the Year Award",
		linkedin: "N/A",
		twitterlink: "",
		...
		goals: "Conti Group delivers program management, construction services, and engineering across the United States and internationally.   - Energy – Conti is involved in projects with waste-to-energy plants, wood pellet plants, etc. and renewable energy projects such as landfill gas power plants.   - Industrial – Conti delivers the highest quality project at the lowest cost possible to their clients.   - Environment – Conti contributes to the environment by remediating contaminated project sites, increasing sustainability and cleaning the nation.   - Infrastructure - Constructing sustainable and integrated transportation systems worldwide including: passenger and freight rail, airport, ferry, bus.",
		...
		news: "Clients Benefit from Conti Entrepreneurial Spirit - http://bit.ly/XjQeGH   Conti Expands in Texas - http://bit.ly/QqcBrh   Conti Continues Growth in the Gulf Coast - http://bit.ly/QCeAbR",
	};	
	...
	companiesData['CMI'] = {
		...
		slogan: "N/A",
		facts: "- Cummins has more than 5,000 facilities in 197 countries and territories.   - World's most environmentally friendly and reliable diesel engines.   - Cummins reuses and recycles more than 48 million pounds of material.",
		linkedin: "N/A",
	...
	companiesData['DAL'] = {
		...
		facts: "- Aircraft fleet of 722 Planes   - Daily Flights- 5,079   - Delta Air Lines serves more than 160 million customers each year   - Delta is investing more than $3 billion through 2013 in airport facilities and global products, services and technology to enhance the customer experience   - During the past year, Delta was named domestic “Airline of the Year” by the readers of Travel Weekly magazine",
		linkedin: "N/A",
		twitterlink: "@Delta",
		fblink: "fb.me/delta",
		rssfeed: "",
		...
		mission: "- Always fly safe.   - Have organic growth in revenue of at least 7%   - Have industry leading productivity   - Create value through:   1. Great customer service   2. Great operations   3. A great brand   4. Best employee relations   5. Great new ideas in all aspects of their business",
		goals: "Delta and its employees strive to:   - Know their customers and care for them: Superior customer service and relationships can be a strategic advantage.   - Know their people and care for them:  Understand their strengths and problems.  Value their differences.   - Hold people accountable and recognize successes.",
		businessModel: "- The Company’s route network gives it a presence in every domestic and international market. Delta’s route network is centered around the hub system it operates at airports in Amsterdam, Atlanta, Cincinnati, Detroit, Memphis, Minneapolis-St. Paul, New York-JFK, Paris-Charles de Gaulle, Salt Lake City and Tokyo-Narita.   - This network is supported by a fleet of aircraft that is varied in terms of size and capabilities.",
	...
	companiesData['DB'] = {
		...
		facts: "About the logo supports the identity of Deutsche Bank:   – the “slash” stands for consistent growth and dynamic development   – the square-shaped frame can be interpreted as a sign of security and a controlled environment",
		linkedin: "N/A",
		...
		overview: "- Deutsche Bank is a leading provider of financial services to agencies, corporations, governments, private individuals and institutions in the Americas.   - Deutsche Bank is one of the largest foreign-based employers in New York City and the only investment bank physically located on Wall Street. Deutsche Bank Americas contributes around 26% of total Group revenues.",
		...
		news: "-Deutsche Bank Educational program receives ‘Charity Times Award’ https://www.db.com/unitedkingdom/content/en/2053.html   -DB research new Asian Markets Frontier http://t.co/9VJMDYgB",
	};
	...
	companiesData['DFWA'] = {
		...
		slogan: "",
		facts: "-2011 Total Passengers: 57,806,918   - Number of employees: 60,000   - World Rankings: 4th in terms of operations   8th in terms of passengers",
		linkedin: " ",
		...
		news: "- Oct. 24 - American Airlines To Launch New International Service From DFW International Airport To Lima, Peru and Seoul, South Korea http://bit.ly/RonF9S   - Aug. 17 - DFW International Airport and Singapore Airlines Launch First Cargo Service to South America Creating Vital Connection with the World’s Fastest Growing Economy - http://bit.ly/TiWvh5   -Sep. 25 - DFW International Airport Installs Free Electric Vehicle (EV) Charging Ports",
	};	
	...
	companiesData['DOW'] = {
		...
		facts: "- The Company's more than 5,000 products are manufactured at 197 sites in 36 countries across the globe.   - Dow is the largest, most flexible and experienced ethylene producer   - Dow is Building critical mass in biotech capabilities to position themselves for future needs.",
		linkedin: "",
		...
		goals: "Dow strives for:   - Connecting chemistry and innovation to generate new ways to solve challenges and exceed customer expectations.   - Taking the extra step to be socially responsible to set themselves apart.   - Appreciating the worth of their people: in the value of each individual employee and their differing experiences, backgrounds and perspectives.   - Build a culture that embraces innovation, responsibility and diversity.",
		businessModel: "- Dow's diversified industry-leading portfolio of specialty chemical, advanced materials, agrosciences and plastics businesses delivers a broad range of technology-based products and solutions to customers in approximately 160 countries and in high growth sectors such as electronics, water, energy, coatings and agriculture   - The focus of Dow's market-driven strategy: Agriculture, Consumer & Lifestyle, Energy and Infrastructure & Transportation.",
		applylink: "www.dow.com/careers/",
		news: "- Dow Chemical to slash 2,400 jobs, close 20 plants - bit.ly/SqBVg1   - Dow, Bend Research Offer Fully Characterized Polymers for Oral Drugs - http://bit.ly/YqnKg1   - Dow Celebrates Polyurethanes Leadership Recognition at CPI – http://bit.ly/UabBvT",
	};
	...
	companiesData['DRS'] = {
		...
		founded: "1969, U.S.",
		slogan: " ",
		facts: "- Fastest growing company in defense technologies   - Finmeccanica was selected for the 2011 Dow Jones Sustainability World Index and DJSI Europe",
		linkedin: "",
		...
		news: "- DRS Technologies Awarded $22.9 Million Contract to Provide Next Generation Light Weapon Thermal Sights to U.S. Army - http://bit.ly/PkCfiQ   - DRS Technologies Earns Highest Designation in Army Expeditionary Warrior Experiment Exercises - http://bit.ly/XWOiFt",
	};
	...
	companiesData['DD'] = {
		...
		facts: "- DuPont claims that it commits 60% of their R&D dollars to ensuring that the world’s growing population has enough to eat.   - In 2011, more than $10 billion of DuPont’s revenues came from products that were introduced within the past 4 years   - In 2011 DuPont introduced more than 1,700 new products and a record number of U.S. patent applications.",
		linkedin: "",
		...
		goals: "- Innovation – unlocking unique value through their leading science and engineering teams worldwide   - Differentiation – focusing resources on the biggest opportunities and most promising business areas   - Productivity – employing a disciplined approach to cost and capital efficiency   - Growth in Developing Markets – meeting the needs of a growing population by focusing on regions with the highest potential.   - Safety and Health - adhere to the highest standards   - Environmental Stewardship - protect the environment while strengthening their businesses",
		businessModel: "- DuPont expects to grow faster than market rates over the next few years by focusing on the most promising businesses, growth in developing markets and continued productivity improvement.   - The company’s market-driven innovation introduces thousands of new products and patent applications every year, serving markets as diverse as agriculture, nutrition, electronics and communications, safety and protection, home and construction, transportation and apparel.",
		applylink: "http://bit.ly/SJaijh",
		news: "- Sustainability Challenges Cost as Packaging Industry’s Top Challenge in Coming Years - http://bit.ly/SL6wYW   - Addressing Food Security Challenge - http://bit.ly/YFgaNL   - DuPont To Eliminate 1,500 Jobs - http://bit.ly/Pw4cED",
	};
	...
	companiesData['ETN'] = {
		...
		facts: "- Over 16 billion dollars in revenue (2010)   - Over 73,000 Employees   - Sells products in over 150 countries",
		linkedin: "",
		...
		businessModel: "The Eaton Business System (EBS) –   - It is based on our belief in standard processes and a teachable point of view.   - It ensures that we transfer best practices and key learning across the organization.   - It encourages continuous improvement.",
		applylink: "http://bit.ly/SxhZIc",
		news: "- Eaton Introduces New Lean Automation Solutions for North American Customers to Control, Reduce Costs http://bitly.com/Pm5F06   - Eaton Announces Net Income Per Share in the Third Quarter of $1.02 http://bitly.com/SdWpII  - Eaton Advances Power Management for Solar Power Installations to Optimize Energy Harvest, Improve System Reliability http://bitly.com/RlTpLr",
	...
	companiesData['LLY'] = {
		...
		facts: "- 10th largest pharmaceutical company in the world   - Average cost to discover and develop a new drug: $800 million to $1.2 billion   - Products marketed in 125 countries   - Employees engaged in Lilly R&D activities: 7,306",
		linkedin: "",
		...
		businessModel: "- The Scientist Magazine \"Top 30 Best Places to Work in Industry\"   - Fortune Magazine \"Global Top Companies for Leaders\"",
		applylink: "http://bit.ly/TxdS3s",
		news: "- DiversityInc Names Lilly the Top Company for Working Families - http://bit.ly/UZMcQG   - Lilly assesses linagliptin treatment in adults with type 2 diabetes, and an add-on to basal insulin therapy - http://bit.ly/UZMcQG   - Lilly’s Fifth Day Global Day of Service focuses on local waterways -http://bit.ly/UZMcQG",
	};
	...
	companiesData['EMC'] = {
		...
		facts: "2010 — 54 percent of college hires in North America came from key schools.   2010 — 25 percent domestic college hires were former interns and coops.",
		linkedin: "",
		twitterlink: "@EMCcorp",
		...
		goals: "-  Create an environment in which healthcare providers can write notes in personal health records (PHR)   -  Add x-ray record capability to PHRs   - Expand the number of lab networks that upload to the PHR   - Expand automated talent management system to streamline the Organization and Talent Review process and make career development resources more readily available to employees",
		businessModel: "- The company’s strategic ability to execute helps them guide clients’ transformations: accelerate the journey to cloud computing, unlock the business value in big data and ensure confidence, manage risk, and build trust. - EMC Consulting   prepares clients to think critically about their greatest challenges to develop strategies that rationalize and optimize the use of growing amounts of information.",
		applylink: "http://bit.ly/MUN9cf",
		news: "- Post media Powers Media Strategy with EMC-Based Private Cloud -bit.ly/SY4dS2   - EMC Signs Extension to IBM Licensing Agreement Through 2017 bit.ly/T53ekP",
	};
	...
	companiesData['EXC'] = {
		...
		slogan: "",
		facts: "- Exelon has been the top-ranked electric and gas utility on the Fortune 500 for five years running.   - Exelon was ranked #1 for the second year in a row on Forbes Magazine.   - Revenues– $32.7 billion  - Employees- 27,000",
		linkedin: "",
		twitterlink: "",
		...
		goals: "-  Keep the lights on and the gas flowing   -  Run the nuclear fleet at world-class levels   -  Capitalize on environmental leadership and clean nuclear energy   -  Create a challenging and rewarding workplace   -  Enhance the value of our generation   -  Build value through disciplined financial management",
		businessModel: "- Safety – for our employees, our customers and our communities   - Integrity – the highest ethical standards in what we say and what we do   - Diversity – in ethnicity, gender, experience and thought   - Respect – trust and teamwork through open and honest communication   - Accountability – for our commitments, actions and results   - Continuous improvement – stretch goals and measured results",
		applylink: "http://bit.ly/QruE3x",
		news: "- Exelon Announces Third Quarter 2012 Results http://bit.ly/VIEi37   - Exelon Nuclear Stations Well Prepared for Hurricane Sandy http://bitly.com/STYL30   - Exelon Corporation Declares Dividend http://bit.ly/UorMpq",
	};
	...
	companiesData['XOM'] = {
		...
		facts: "- Largest publicly traded petroleum and petrochemical enterprise in the world.   - Brands include Exxon, Esso, and Mobil.   - Mobil invented the process for converting Methanol into high-octane gasoline.",
		linkedin: "",
		...
		goals: "Exxon Mobil Corporation is committed to being the world's premier petroleum and petrochemical company. To that end, we must continuously achieve superior financial and operating results while simultaneously adhering to high ethical standards.   - Communities S We commit to be a good corporate citizen in all the places we operate worldwide.   - Shareholders - We are committed to enhancing the longSterm value of the investment dollars entrusted to us by our shareholders.   - Customers - Success depends on our ability to consistently satisfy ever-changing customer preferences.   - Employees - The exceptional quality of our workforce provides a valuable competitive edge.",
	...
	companiesData['FBI'] = {
		...
		founded: "July 26, 1908 US",
		slogan: "Fidelity, Bravery, and Integrity",
		facts: "-Has 35,576 employees -2011 budget: $7.9 billion",
		linkedin: " ",
		twitterlink: "http://bit.ly/TFo3hr",
		fblink: "http://on.fb.me/OQZNM3",
		rssfeed: " ",
		lookfor: "Chemical, Computer science, Electrical, Software, and Mechanical Engineering.",
		overview: "The Federal Bureau of Investigation (FBI) is an agency of the United States Department of Justice that serves as both a federal criminal investigative body and an internal intelligence agency (counterintelligence). The FBI has investigative jurisdiction over violations of more than 200 categories of federal crime. The FBI's headquarters is located in Washington, D.C.",
		mission: "The mission of the FBI is to protect and defend the United States against terrorist and foreign intelligence threats, to uphold and enforce the criminal laws of the United States, and to provide leadership and criminal justice services to federal, state, municipal, and international agencies and partners.",
		goals: "Keeping the United States safe and criminal laws enforced, effectively keeping government running smoothly.",
		businessModel: "-Rigorous obedience to the Constitution of the United States; -Leading and coordinate intelligence efforts  to protect the US. -Delivering the reliable and effective technology solutions needed to fulfill the FBI's mission anytime, anywhere, on-time, and on-budget; -Understand threats, continue to integrate intelligence and law enforcement capabilities in every FBI operational program, and continue to expand contribution to the Intelligence Community knowledge base.",
		applylink: "http://www.fbijobs.gov/2.asp",
		news: " ",
	...
	companiesData['FRPC'] = {
		...
		id: "FRPC",
		logo: "FRPC.png",
		industries: "Intellectual Property Law",
		founded: "1878",
		slogan: "N/A",
		facts: "- Fish and Richardson has over 350 attorneys. -Fish is one of the most sought-after firms for both patent prosecution and patent litigation services among Fortune 100 companies -The firm’s growing regulatory group advises clients seeking to market products subject to United States Federal Communications Commission and the Food and Drug Administration regulation.",
		linkedin: " ",
		twitterlink: "http://bit.ly/TSP0hg",
		fblink: "http://on.fb.me/TSOY9m",
		rssfeed: " ",
		lookfor: "They seek individuals with backgrounds in computer science, electrical engineering, mechanical engineering, chemistry, biology, and other life sciences.",
		overview: "Fish & Richardson P.C. is a national law firm practicing intellectual property law.",
		mission: "Fish has top-rated intellectual property, litigation, transactional, and regulatory services to help you maximize their costumers maximize their IP.",
		goals: "Because of the depth, breadth, and variety of technological and legal experience of their team, they are immediately familiar with virtually any technology.",
		businessModel: "-They emphasize the provision of legal services to persons and nonprofit organizations with limited means, and the protection of important civil and public rights. -They provide their attorneys with full hour’s credit for approved pro bono matters, and by assigning a principal-level attorney in each of their U.S. offices with the task of seeking out and publicizing local pro bono opportunities.",
		applylink: "http://bit.ly/VChSfa",
		news: " ",
	...
	companiesData['FLR'] = {
		...
		id: "FLR",
		logo: "FLR.png",
		industries: "Energy, Chemicals, Construction",
		founded: "1912: Santa Ana, California",
		slogan: "N/A",
		facts: "-No. 1 in Fortune’s “Engineering Construction” category -~42000 employees in 30 countries  -Ranked No.124 on Fortune 500 list in 2011",
		linkedin: " ",
		twitterlink: "@$FLR",
		fblink: " ",
		rssfeed: " ",
		lookfor: "No specific engineering majors listed",
		overview: "Flour works with governments and multinational companies to design, build, and maintain many of the world’s most complex and challenging capital projects in engineering, procurement, construction, and maintenance (EPCM).",
		mission: "Maintain its standing as “the preeminent leader in the global building services market place.”",
		goals: "To develop, execute, and maintain capital projects on schedule, within budget, and with operational excellence.",
		businessModel: "The characteristics of outstanding dependability, expertise, and safety allow Flour to be cnsidered one of the most successful companies globally in its field. These values also permit the success of the company’s goal.",
		applylink: "http://bit.ly/RmgXPx",
		news: " ",
	...
	companiesData['FMCT'] = {
		...
		id: "FMCT",
		logo: "FMCT.png",
		industries: "Oil and gas equipment, services.",
		founded: "2001: Houston, Texas",
		slogan: "We put you first, and keep you ahead.",
		facts: "-16,100 employees and operates 27 production facilities over 16 countries. -John T. Gremp was appointed President and CEO of FMC Technologies.",
		linkedin: " ",
		twitterlink: " ",
		fblink: " ",
		rssfeed: " ",
		lookfor: "Chemical, Civil, Electrical, Environmental, Materials Science & Mechanical Engineers",
		overview: "FMC Technologies is a leading global provider of technology solutions for the energy industry.",
		mission: "FMC Technologies is to identify the problems of their customers to make their jobs easier and their operation more successful. They offer new innovation ways to improve oil and gas extraction. At FMC Technologies, they put their customers first and keep them ahead.",
		goals: "FMC Technologies Inc. main goal is to create innovation technology that will guarantee a better business relationship between them and their customers. These are better explained in the leading business aspects: -Subsea Systems: Their innovative technologies, proven reliability and customer support throughout the years have increase production and reduce cost offshore oilfields. -Surface Wellhead: Their technologies and worldwide service locations help operators boost well site performance, saving and safety. -Blending and Transfer Systems: FMC Tech systems and automations technologies deliver precise, cost-efficient fluid blending processes.",
		businessModel: "FMC Technologies designs, manufactures and services tecnologial sohisticated systems and products such as subsea productions and processing systems, surface wellhead systems and marine loading systems for the oil and gas industries.",
		applylink: "http://is.gd/dQUHRz",
		news: " ",
	...
	companiesData['FCX‎'] = {
		...
		logo: "FCX.png",
		industries: "Mining",
		founded: "1980’s: Phoenix, Arizona",
		slogan: "\"Long-live, geographically diverse operations\"",
		facts: "- Ranks 240th in the Fortune 500 - World’s largest publicly traded copper producer - World’s largest producer of molybdenum",
		linkedin: "www.fcx.com",
		twitterlink: "N/A",
		fblink: "N/A",
		rssfeed: "",
		lookfor: "Chemical, Materials Science, Environmental, Civil, Electrical, Mechanical, and Industrial Engineers.",
		overview: "Freeport-McMoRan currently ranks second among the top 10 producers of copper producers. This company trades approximately 9 percent of the total worldwide estimated mined copper production.",
		mission: "The company strives to maintain a competitive edge through operational excellence and innovation. Its skills include the breakthrough developments of novel methods for exploring, mining, and processing – paving the way for less energy intensive, more environmentally sound, and more cost-effective operations.",
		goals: "Because growth is key to the company’s business strategy, finding new sources of copper and other metals through exploration, acquisition or partnerships is the lifeblood of Freeport-McMoRan.",
		businessModel: "A significant number of the exploration effort focuses on existing ore bodies owned by the company.Exploration methods have grown more sophisticated and precise, as have mining and processing technologies. In addition, the company’s Process Technology Center and the exploration group collaborate to ensure the continued discovery and development of economically viable mineral reserves and creation of low-cost production and process technologies.",
		applylink: "http://bit.ly/Xbiifs",
		news: "",
	...
	companiesData['HALLMK'] = {
		...
		id: "HALLMK",
		logo: "HALLMK.png",
		industries: "Greeting cards, Specialty Retail",
		founded: "1910 Kansas City, Missouri",
		slogan: "\"When you care enough to send the very best.\"",
		facts: "-2011 earnings: $4.1 billion -Number of employees: 12,600 worldwide -10,000 new and redesigned greeting cards each year",
		linkedin: " ",
		twitterlink: "@HallmarkPR",
		fblink: " ",
		rssfeed: " ",
		lookfor: "Chemical, Industrial, Materials Science, Mechanical Engineers, and other Engineering disciplines",
		overview: "Hallmark is a greeting card company that makes cards for the important moments of people’s lives. Hallmark helps give voice to caring thoughts and emotions with tangible reminders of appreciation, belonging and love.",
		mission: "To be the company that creates a more emotionally connected world by making a genuine difference in every life, every day.",
		goals: "To continue their creativity and innovation in their products, providing the best form of expression for the special moments in their customers’ lives—big or small.",
		businessModel: "Beliefs that guide their business strategies: -That their products and services must enrich people's lives. -That creativity and quality – in their products, services and all that they do – are essential to their success. -That innovation in all areas of their business is essential to attaining and sustaining leadership. -Excellence in all they do. -High standards of ethics and integrity. -Caring and responsible corporate citizenship for Kansas City and for each community in which they operate.",
		applylink: "http://bit.ly/TiZs1b ",
		news: " ",
	...
	companiesData['HRS'] = {
		...
		founded: "December 3 of 1895 in Niles, Ohio.",
		slogan: "N/A",
		facts: "-Harris is the number one supplier of tactical radios to NATO and the U.S. Department of Defense -Harris has the largest global managed satellite network in the world  -Harris is building the ground segment of the world’s most advanced weather data processing network",
		linkedin: " ",
		twitterlink: "HarrisCorp ",
		fblink: "on.fb.me/QCoDyR",
		rssfeed: " ",
		lookfor: "Industrial, Computer, Mechanical, Electrical Engineers",
		overview: "Harris Corporation (Harris), together with its subsidiaries, is an international communications and information technology company serving government and commercial markets in more than 150 countries. The Company operates in three segments: RF Communications segment, Government Communications Systems segment and Broadcast Communications segment.",
		mission: "To be the best-in-class global provider of mission-critical assured communications systems and services to both government and commercial customers.",
		goals: "-Integrity : No compromise on values to achieve success. -Delivering Customer Value -Collaboration/Teamwork/Global Inclusion:  creative solutions and success comes from working together to achieve goals -Results Oriented Environment:  Continuous Improvement -Innovation: Focus on solving mission-critical needs through innovation and creative thinking. -Personal Growth and Fulfillment",
		businessModel: "-Its RF Communications segment consists of its tactical radio communications and public safety and professional communications businesses.  -Its Government Communications Systems segment consists of its defense programs, national intelligence programs, civil programs and information technology services businesses. -Its Broadcast Communications segment consists of its workflow, infrastructure and networking solutions, media and transmission systems businesses.",
		applylink: "http://bit.ly/PBoI3h",
		news: " ",
	...
	companiesData['HPC'] = {
		...
		logo: "HPC.png",
		industries: "Construction",
		founded: "1937: Greeley, Colorado",
		slogan: "N/A",
		facts: "-In 1989 Hensel Phelps passed to twenty-eight employees stockholders -1990, Hensel Phelps became the largest construction firm in Colorado, thirty-fourth in the country",
		linkedin: " ",
		twitterlink: "@HPCCDC",
		fblink: "http://on.fb.me/TaTFyW",
		rssfeed: " ",
		lookfor: "Industrial, Civil Engineering",
		overview: "Since 1937, Hensel Phelps Construction Co. (Hensel Phelps) has delivered the best value in building services by placing expert construction professionals on every project undertaken. The company is consistently ranked among the top general contractors and construction managers in the nation by ENR (Engineering News Record).",
		mission: "Hensel Phelps Construction Co.'s mission is to build a construction company of superior strength, competence and reputation. This mission is based upon the twin foundations of commitment to employee growth and the dedication to exceptional customer service.",
		goals: "Hensel Phelps is committed to protecting the environment. This commitment is fulfilled by incorporating sustainable principles and environmentally responsible practices into the company’s administrative and construction operations throughout the company. Fundamentally, this responsibility leads to individual actions that enhance human health and foster a transition toward sustainability.",
		businessModel: "-As a leading design-build firm, Hensel Phelps has an opportunity to contribute to both the design and construction phases of a project. -Well known for having one of the best training programs in the nation, Hensel Phelps offers LEED/Sustainability training as a part of its ongoing training curriculum.",
		applylink: "http://bit.ly/X1jKli",
		news: " ",
	...
	companiesData['HPQ'] = {
		...
		id: "HPQ",
		logo: "HPQ.png",
		industries: "Computer hardware, Computer software, IT services, IT consulting",
		founded: "1939 Palo Alto by William (Bill) Redington Hewlett and Dave Packard",
		slogan: "Invent",
		facts: "-Hewlett-Packard is an American multinational information technology corporation headquartered in Palo Alto, California -The company’s first product, built in a Palo Alto garage, was an audio oscillator -One of HP’s first customers was Walt Disney Studios -More than 300,000 employees -Revenue: $127.24 billion -Meg Whitman, President and CEO",
		linkedin: " ",
		twitterlink: "@hpnews",
		fblink: "www.facebook.com/HP",
		rssfeed: " ",
		lookfor: "Electrical Engineering, Computer Science, Computer Engineering, Mechanical Engineering, Industrial Engineering, Information Technology",
		overview: "Provides technologies, software’s, and solution/services from the individual to government scale. The company is divided into seven sections including: Services, Enterprise Storage and Servers, HP Software, Personal Systems Group, Imagining and Printing Group, HP Financial Services, and Corporate investments.",
		mission: "Consumer loyalty, profit, growith, market leadership, commitment to employees, and global citizenship.",
		goals: "Increase Regular Quarterly Dividend by 50 Percent. Reduce the combined energy consumption and associated greenhouse gas emissions of HP operations and products by 25 percent below 2005 levels. ",
		businessModel: "-\"It is necessary that people work together in unison toward common objectives and avoid cross purposes at all levels if the ultimate in efficiency and achievement is to be obtained,\"Dave Packard, Co Founder. -We have provided comprehensive management and modernization solutions in a broad range of industries for more than 40 years. We combine specialized knowledge of legacy computing environments with an understanding of the latest technologies. That enables us to develop innovative modernization solutions to help you move applications to modern platforms, architectures and delivery models.",
		applylink: "http://www8.hp.com/us/en/jobsathp/students-graduates/overview.html",
		news: " ",
	...
	companiesData['HMC'] = {
		...
		id: "HMC",
		logo: "HMC.png",
		industries: "Automotive, Aviation",
		founded: "September 1948, Japan",
		slogan: "\"The Power of Dreams\"",
		facts: "-World's largest motorcycle manufacturer -Directly employs nearly 25,000 Americans -In 1959 Honda opened its first storefront in Los Angeles with six industrious employees",
		linkedin: " ",
		twitterlink: "http://bit.ly/R6WiAO",
		fblink: "http://on.fb.me/WbjRy",
		rssfeed: " ",
		lookfor: "Industrial, Mechanical, Electrical, Materials, and civil engineering",
		overview: "Honda is a Japanese public multinational corporation primarily known as a manufacturer of automobiles and motorcycles. Honda has been the world's largest motorcycle manufacturer since 1959, as well as the world's largest manufacturer of internal combustion engines measured by volume, producing more than 14 million internal combustion engines each year.",
		mission: "Honda sees the pursuit of impossible dreams as an empowering force, capable of producing revolutionary ideas. Dreams inspire them to create innovative products that enhance human mobility and benefit society. Honda encourages all of its associates to pursue their dreams. And it's their mission to share these dreams with others and to make them a reality.",
		goals: "Honda sees it as their responsibility to serve humanity through their global commitments to helping protect the environment and enhancing safety in a mobile society. Honda believes that their future innovations and competitive advantage will come from engaged diverse associates with the capacity to dream",
		businessModel: "-Honda sees \"The Power of Dreams\" as a way of thinking that guides them and pushes them forward. The strength of their company comes from this philosophy. -They see things from a global perspective, always striving to create and produce products of the highest quality at a reasonable price for worldwide customer satisfaction.",
		applylink: "http://bit.ly/Rd5DWG",
		news: " ",
	...
	companiesData['HRLL'] = {
		...
		id: "HRLL",
		logo: "HRLL.png",
		industries: "phyical science , engineering, and defense",
		founded: "1948: Malibu, CA",
		slogan: "N/A",
		facts: "-First location for the first demonstrated use of a laser -Currently owned by General Motors Company and Boeing -More than 500 patents filed since 1997",
		linkedin: " ",
		twitterlink: "N/A",
		fblink: "http://on.fb.me/RKioGY",
		rssfeed: " ",
		lookfor: "Mechanical, Chemical, Materials Science, Electrical, Aerospace and Computer Science Engineering",
		overview: "HRL describes itself as enhancing technologies for automotive, aerospace and defense that make the US safer, support our national security and improve our quality of life",
		mission: "To develop knowledge and technologies that are adopted by our LLC Members and customers and result in their competitive or strategic advantage",
		goals: "To provide our LLC Members and customers with the technologies important to their success in the global marketplace",
		businessModel: "People first: treating employees with respect, Integrity: maintaing honesty and good moral code, Customer focused: anticipate needs of customers, Excellence: continuous improvement. By upholding all 4 values HRL Laboratories plans to accomplish their mission and goal.",
		applylink: "http://www.hrl.com/careers/cars_jobs.html",
		news: " ",
	...
	companiesData['IBM'] = {
		...
		id: "IBM",
		logo: "IBM.png",
		industries: "Computer Hardware and Software, IT Services, IT Consulting",
		founded: "-June 16, 1911 Endicott, New York -Founder: Charles Ranlett Flint",
		slogan: "“T H I N K”",
		facts: "-Revenue: $106.9 billion -Net income: $15.9 billion -Total assets: $116.4 billion -Number of employees (worldwide): 433,362 -The Watson project began in 2006 with a team of IBM researchers collaborating with leading universities on a project called “Deep QA.” -IBM is headquartered in Armonk, New York -CEO, Virginia M (Ginni) Rometty -Thomas J. Watson led IBM from 1914-1956 with his favorite slogan “THINK”",
		linkedin: " ",
		twitterlink: "@smarterplanet",
		fblink: "facebook.com/peopleforasmarterplanet",
		rssfeed: " ",
		lookfor: "All Engineering majors",
		overview: "As a top company in the Information Technology Services industry, International Business Machines (IBM) specializes in Computer Hardware, Computer Software, Consulting and IT Services.",
		...
		goals: "Help clients succeed in delivering business value by becoming more innovative, efficient and competitive through the use of business insight and information technology (IT) solutions and providing long-term value to shareholders",
		businessModel: "-The Global Technology Outlook (GTO) is an annual study conducted by IBM Research that identifies significant technology trends.  It looks for high impact disruptive technologies that will lead to game-changing products and services over a 3 to 10 year horizon.  Technology thresholds identified in the GTO demonstrate their influence on clients, enterprises, and industries and have high potential to create new businesses. -IBM Intelligent Operations Center for Cloud is Software as a Service (SaaS) solution, allowing cities of all sizes to quickly get started by integrating information across city operations to help improve the delivery of city services.  This solution provides a unified view of events across agencies, departments and services, enabling effective collaboration, and communication so city leaders can rapidly respond to incidents.",
		applylink: "www.ibm.com/jobs",
		news: " ",
	...
	companiesData['ITW'] = {
		...
		founded: "1912 Chicago, Illioins",
		slogan: "“Local focus, Global reach”",
		facts: "-A leading global manufacturing with nearly 100 years of industry -Employs nearly 60,000 people in over 800 business in over 50 countries",
		linkedin: " ",
		twitterlink: "https://twitter.com/ITWIndustry",
		fblink: "http://www.facebook.com/pages/Illinois-Tool-Works/109618109064801?sk=info",
		rssfeed: " ",
		lookfor: "Electrical, Mechanical, Materials & Software Engineers",
		overview: "ITW is a diversified manufacturer of advanced industrial technology. Specifically, they design and produce an array of highly engineered fasteners and components, equipment and consumable systems, and specialty products and equipment for customers around the world.",
		mission: "At ITW, they maximize the power of our global diversity, resulting in superior innovation, productivity and business growth. They believe that diverse perspectives, open communication and inclusion create customer satisfaction, employee motivation, rewarding vendor partnerships, greater return on investment for shareholders and better communities in which to work and live.",
		goals: "To be the recognized leader in the markets they serve by providing innovative products and superior technical support.",
		businessModel: "To achieve their vision, they will: -Foster a diverse, inclusive environments & workforce where employees are encouraged to share ideas. -Cultivate business opportunities & customer relationships -Practice Decentralization -Use 80/20 Process -Practice Innovation",
		applylink: "http://bit.ly/SPvDJl",
		news: " ",
	...
	companiesData['IFOYS'] = {
		...
		goals: "Work to understand the needs and requirements of our clients before proposing a solution. Develop responsive proposals that provide cost-effective solutions to our clients needs. Deploy the right mix of people and products to deliver value-added services and solutions to our clients.",
		businessModel: "We deliver measurable business value in 3 ways: Transform: we can transform the fundamental shape of your business P&L. Regardless of which team you engage with, we have a best-practice process for delivering value. Optimize: beyond transformation and innovation, it boils down to execution - delivering on time, on budget and \"on value\". We can optimize your core operations to drive best-in-class efficiency and help fund the transformation and innovation. Innovate: We can inject a level of product and service innovation into your business to create new revenue opportunities through collaboration and co-creation. We keep abreast of the latest technology and how it applies to your business issues. What you get from us is best-of-breed solutions.",
		applylink: "http://www.infosys.com/careers/apply-now/apply.asp",
		news: " ",
	...
	companiesData['INR'] = {
		...
		id: "INR",
		logo: "INR.png",
		industries: "Internship Recruitment",
		founded: "1970: Chicago",
		slogan: "N/A",
		facts: "-Named by Vault as a Top 10 Internship in America for 2010 -INROADS is an international organization with over 35 offices -Started with just 25 college interns",
		linkedin: " ",
		twitterlink: "http://bit.ly/SvzuuU",
		fblink: "http://on.fb.me/StvbB9",
		rssfeed: " ",
		lookfor: "All types of Engineers",
		overview: "INROADS is the nation’s largest non-profit source of paid internships for undergraduate, diverse youth. By providing the skills, support, and network students need to obtain an internship at a top company, INROADS prepares students to lead and contribute from Day 1",
	...
	companiesData['INTC'] = {
		...
		logo: "INTC.png",
		industries: "Technology",
		founded: "July 18, 1968 Mountain View, California, US",
		slogan: "Sponsors of Tomorrow",
		facts: "-2011 net revenue: $54 billion -In 1971, Intel introduced the first semiconductor -Astronauts on the Space Shuttle Endeavour used Intel’s ProShare Personal Conferencing software to share info with NASA flight coordinators at the Johnson Space Center in Houston, Texas.",
		linkedin: " ",
		twitterlink: "@Intel",
		fblink: "on.fb.me/V7TczB",
		rssfeed: " ",
		lookfor: "Computer Science/Engineer, Industrial, Mechanical and Chemical",
		overview: "Intel is the world leader in silicon innovation, it develops technologies, products, and initiatives to continually advance how people work and live. Founded in 1968 to build semiconductor memory products, Intel introduced the world's first microprocessor in 1971.",
		mission: "This decade, Intel plans to create and extend computing technology to connect and enrich the lives of every person on earth.",
		goals: "-Extend our silicon technology and manufacturing leadership. -Deliver unrivaled microprocessors and platforms -Grow profitability worldwide -Excel in customer orientation",
		businessModel: "Current sectors and projects Intel is currently working on: -Cleantech  -Manufacturing and Memory  -Computing -Software and Services -Consumer Internet -Mobility -Digital Home and Digital Media",
		applylink: "http://intel.ly/W9ZqNg",
		news: " ",
	...
	companiesData['JEC'] = {
		...
		facts: "-Total worldwide employees: More than 60,000 -2010 Revenues: $9.9 billion -Ranks 250 in Fortune 500",
		linkedin: " ",
		twitterlink: " ",
		fblink: " ",
		rssfeed: " ",
		...
		goals: "-They are a relationship-based company; this first core value is also their fundamental business strategy: \"We focus on forging strong, long-term relationships with our clients.\"  -Growth is an imperative; their clients’ needs drive their business, so Jacob Engineering grows in pace with their clients’ growth.  -People are their greatest asset; employee talent is the cornerstone of their success: “Their expertise and capabilities win us the work, perform the work, create value for our clients, and generate loyalty in our investors.”",
	...
	companiesData['DE'] = {
		...
		facts: "-Worldwide company -Fortune 500 company",
		linkedin: "N\A",
		...
		businessModel: "-Provide products and service in Agricultural, Residential, Golf & Sports, Commercial, Constructions, Forestry, and Engines & Drivetrains industry.  -Focus mainly in United States and Canada, Europe, Brazil, Russia, India, and China.",
	...
	companiesData['JNJ'] = {
		...
		facts: "-World’s sixth-largest consumer health company -World’s largest and most diverse medical devices and diagnostics company -World’s fifth-largest biologics company. ",
		linkedin: " ",
		twitterlink: "@JNJComm",
	...
	companiesData['LANC'] = {
		...
		facts: "-Recognized as the largest air cargo carrier in Latin America -The transportation of Live Animals is a specialty of LAN CARGO -LAN CARGO and its affiliates are leaders in the transportation of Flowers from Colombia and Ecuador to the world.",
		linkedin: " ",
	...
	companiesData['LXK'] = {
		...
		facts: "-The company is headquartered in Lexington, Kentucky.  -Lexmark reported $4 billion in revenue in 2011, with approximately 58% of that revenue coming from international sales.\n-Products are sold in more than 170 countries in North and South America, Europe, the Middle East, Africa, Asia, the Pacific Rim and the Caribbean.",
		linkedin: " ",
		...
		goals: "-Customer Commitment: Customer satisfaction is the top priority of every employee and the purpose of every job -Long-Term Perspective: As a daily priority, Lexmark will make decisions to invest long term while managing short-term demands -Excellence: Excellence is the performance of every task in a superior manner -Employee Satisfaction: Our people are our future.",
	...
	companiesData['LECO'] = {
		...
		facts: "-2011 earnings: $2.69 billion -40 manufacturing locations worldwide -Sells in markets in 160 countries",
		linkedin: " ",
	...
	companiesData['LMT'] = {
		...
		facts: "-One of the world’s largest defense contractors -The company has received the Collier Trophy six times -Recognized in 2011 as one of the top companies in climate change practice by the CDP 500 Global Report",
		linkedin: " ",
	...
	companiesData['LUME'] = {
		...
		facts: "-Contains more than 15,400 megawatts of generation, 2,300 MW fueled by nuclear power and 8,000 MW fueled by coal -More than 900 MW of wind energy  -Mined and restored 69,300 acres and planted more than 31.6 million trees",
		linkedin: " ",
		...
		businessModel: "-The Luminant Power Track program is gaining national attention for its effective collaboration between Luminant and Tyler Junior College -Luminant's Comanche Peak Nuclear Power Plant has been named a recipient of the State Board of Education's Employers for Education Excellence Award for 2012",
	...
	companiesData['LYB'] = {
		...
		founded: "1985",
		slogan: "N/A",
		facts: "-LyondellBasell is the world’s third-largest independent chemical company -Giulio Natta and Karl Ziegler (two of LyondellBassell first scientists) were jointly awarded the Nobel Prize in Chemistry for their discoveries in polyolefins technology and catalysts in 1963",
		linkedin: " ",
	...
	companiesData['MAES'] = {
		...
		facts: "-Started with Robert Von Hatten -Just in the last two years, MAES has touched the lives of over 50,000 students, professionals, and educators -Received its charter on March 28, 1975.",
		linkedin: " ",
		...
		goals: "-Increase the number of Mexican Americans and other Hispanics in the technical and scientific fields -National organization that would serve as a source for role models -Address of the needs of its members -Become a resource for industry and students",
	...
	companiesData['MWV'] = {
		...
		facts: "-15,000 Employees worldwide -700,000+ acres of forestland under sustainable management -150+ different product lines",
		linkedin: " ",
		twitterlink: " ",
		fblink: " ",
		rssfeed: " ",
		...
		goals: "-Communities - to help strengthen and enrich the communities where MWV has major operations, and where MWV employees and their families live and work.\n-Customers – To provide the best possible packaging solutions - Employees - We attract employees with different backgrounds and experiences to harness their knowledge and insight to create solutions for customers around the world. Every employee is valued for their unique contribution to the team.",
	...
	companiesData['SLB'] = {
		...
		id: "SLB",
		logo: "SLB.png",
		industries: "Oilfield services and equipment",
		founded: "1926: Houston, Texas",
		slogan: "\"Taking on the world's toughest energy challenges.\"",
		facts: "- $36.96 billion revenues (FY11) - Employees over 115,000 people of more than 140 nationalities. - Operating in approximately 85 countries.",
		linkedin: "",
		twitterlink: "N/A",
		fblink: "N/A",
		rssfeed: "",
		lookfor: "Chemical, Civil, Electrical, Environmental, Industrial, Materials Science & Mechanical Engineers",
		overview: "Schlumberger Technology is the world’s largest oilfield services company.",
		mission: "As a leading oilfield services provider, Schlumberger is trusted to deliver superior results and improved E&P performance for oil and gas companies around the world.",
		goals: "Making the most our unique assets, Schlumberger is committed to providing service that enhance and optimize customers' performance. These are three well-established goals: - Our people thrive on the challenge to excel in any enviromen and their dedicatio to safety and customer service worldwide is our great strength. - Our commitment to technology and qualit is the basis for our competitive advantage. - Our termination to produce superior profits is the cornerstone for our future independence of action and growth.",
		businessModel: "With 25 research and engineering facilities worldwide, we place strong emphasis on developing innovative technology that adds value for our customers. In 2011, we invested $1.1 billion in R&D.",
		applylink: "http://careers.slb.com/recentgraduates.aspx",
		news: "",
	};	
	...
	companiesData['SHELL'] = {
		...
		founded: "1900: London, UK",
		slogan: "\"Let’s go.\"",
		facts: "-3.2 million barrels of gas and oil were produced every day (2011). -48% of their production is natural gas. -$2.3 billion spent on developing alternative energies, carbon capture and storage, and on CO2 R&D over the past five years. (2011)",
		linkedin: "",
		twitterlink: "@Shell",
		fblink: "http://on.fb.me/PPR1jk",
		rssfeed: "",
		lookfor: "Chemical, Civil, Electrical, Environmental, Industrial, Materials Science & Mechanical Engineers",
		overview: "Shell is a global group of energy and petrochemical companies. Their activities include exploration and extraction of crude oil and natural gas, refineries, supply chain, trading and shipping crude, manufacturing and marketing of products, and production of petrochemicals for industrial customers.",
		mission: "Engage efficiently, responsibly and profitably in oil, oil products, gas, chemicals and other selected businesses and to participate in the search for and development of other sources of energy to meet evolving customer needs and the world’s growing demand for energy.",
		goals: "Meet the energy needs of society, in ways that are economically, socially and environmentally viable, now and in the future. Seek a high standard of performance, maintaining a strong long-term and growing position in the competitive environments in which the company chooses to operate. Work closely with their customers, their partners and policymakers to advance more efficient and sustainable use of energy and natural resources.",
		businessModel: "Shell’s businesses is divided into three areas: upstream, downstream, and project & technology. In Upstream the company focuses on exploring for new oil and gas reserves and developing major projects where their technology and know-how adds value to the resource holders. In Downstream, there is an holded emphasis on sustained cash generation from  existing assets and selective investments in growth markets. Projects & Technology manages delivery of Shell’s major projects and drives the research and innovation to create technology solutions.",
		applylink: "http://bit.ly/2jf0L",
		news: "",
	};	
	...
	companiesData['SSP'] = {
		...
		id: "SSP",
		logo: "SSP.png",
		industries: "Strategic Weapons Systems",
		founded: "1955",
		slogan: "\"Developing and Deploying Our Nation's Seaborne Strategic Weapons Systems\"",
		facts: "- Manages the TRIDENT II SWS which is the primary strategic deterrent for both the US and the UK - Responsible for security and safety of nuclear weapons while in US Navy custody- During the past several years, SSP has been able to leverage its expertise in program management and systems engineering into six lines of business",
		linkedin: "",
		twitterlink: "N/A",
		fblink: "N/A",
		rssfeed: "",
		lookfor: "General Engineer",
		overview: "Strategic Systems Programs or SSP is a subsidiary of the United States Navy that is responsible directing and managing the Navy’s strategic weapons systems.",
		mission: "\"Provide credible and affordable solutions to the warfighter\"",
		goals: "Apply SSP values and abilities to:- Deliver high performance and responsive products to the warfighter- Meet and/or exceed stakeholders' expectations- Continually improve our processes- Enrich the civilian and military workforce- Sustain the Government / contractor strategic alliance",
		businessModel: "SSP, today, has established what they call the  “Six Lines of Business”. These are the six areas of responsibility held by the SSP and include: Strategic Weapons Systems (SWS), Nuclear Weapons Security (NWS), SSGN Attack Weapons System (AWS), Payload Integrator, Emerging Missions, Navy Treaty Implementation Program (NTIP). All except the last deal with the effective management of different weapons systems of different Navy vessels; at sea-level and below.",
		applylink: "http://bit.ly/PKf2Z8",
		news: "",
	};	
	...
	companiesData['STFM'] = {
		...
		founded: "1922: Bloomington, Illinois",
		slogan: "\"Like a good neighbor, State Farm is there.\"",
		facts: "- State Farm has about 66,000 employees.- State Farm is the leading insurer of watercraft.- State Farm also has a line of business with mutual funds and banking products.",
		linkedin: "",
		twitterlink: "http://bitly.com/SbeDKI",
		fblink: "http://on.fb.me/IYxKCQ",
		rssfeed: "",
		lookfor: "Computer Engineers",
		overview: "State Farm is a leading automobile insurance company in the United States and in Canada. State Farm also provides other forms of insurance such as homeowners, motorcycle, life, health insurance, etc.",
		mission: "State Farm establishes the presence of “a good neighbor” by providing automobile and other types of insurance, as well as contributing to the community through safety, grants and education.",
		goals: "State Farm is committed to being the world's premier automobile insurance company. In doing so, the company focuses on its customers to provide them the best insurance available in the interest of their safety.",
		businessModel: "State Farm has come a long way since 1922. Their success today is built on the same foundation of shared values: - Quality service and relationships- Mutual trust- Integrity- Financial strength.",
		applylink: "http://bit.ly/WYO8ya",
		news: "",
	};	
	...
	companiesData['SYK'] = {
		...
		founded: "1941 Kalamazoo, MI",
		slogan: "\"First be Best, then be First\"",
		facts: "- Recently the company named Kevin A. Lobo as its new CEO.- Employees- 20,202- Stryker recently acquired Surpass Medical.",
		linkedin: "",
		twitterlink: "@strykercomm",
		fblink: "on.fb.me/SpGo2x",
		rssfeed: "",
		lookfor: "Biomedical, Electrical, Mechanical Engineers",
		overview: "Develops, manufactures and markets surgical and medical products such as joint replacement implants, trauma, spine, and micro surgeries. Other products and services include orthobiotics, surgical navigation, endoscopic, communications and digital imaging systems, and emergency medical equipment.",
		mission: "Stryker is one of the world’s leading medical technology companies and it is dedicated to helping healthcare professionals perform their jobs more efficiently while enhancing patient care. ",
		goals: "The company’s goal was to help patients lead healthier, more active lives through products and services that make surgery and recovery simpler, faster and more effective",
		businessModel: "- The Company offers a diverse array of innovative medical technologies, including reconstructive, medical and surgical, and neurotechnology and spine products to help people lead more active and more satisfying lives.- Stryker pushes the frontiers of medical research with uncompromising clinical integrity to improve the lives of patients around the world. - Stryker is a trusted partner that works with thousands of surgeons, and builds best practices into everything they do. They are committed to working with the customer to meet their patients’ needs.",
		applylink: "http://bit.ly/TslTkA",
		news: "",
	};	
	...
	companiesData['TGT'] = {
		...
		founded: "First Target Store opens in 1962 in Roseville, MN",
		slogan: "\"Expect More. Pay Less.\"",
		facts: "- Fortune magazine ranked Target No. 25 on its list of \“World’s Most Admired Companies.\”- Target was ranked #44 on  DiversityInc's \"Top 50 Companies for Diversity.\”- 5% of the company’s income goes to strengthen the communities where its stores operate",
		linkedin: "",
		twitterlink: "@Target",
		fblink: "on.fb.me/VcDGRe",
		rssfeed: "",
		lookfor: "Electrical , Industrial , Material Sciences , Mechanical Engineers",
		overview: "Target is an upscale discounter that provides high-quality, on-trend merchandise at attractive prices in clean, spacious and guest-friendly stores. In addition, Target operates an online business, Target.com.",
		mission: "Targets mission is to make Target your preferred shopping destination in all channels by delivering outstanding value, continuous innovation and exceptional guest experiences by consistently fulfilling their “Expect More. Pay Less.” brand promise.",
		goals: "Target’s core Beliefs:- Design for all: Great design affordable to everyone.- Great Guest Service: Make customers shopping enjoyable & exciting- More for Your Money: Offer the best value- Create a Fun and Rewarding place to work- Celebrate Diversity",
		businessModel: "The company operates in two segments: Retail and Credit Card. - The Retail Segment includes all of merchandising operations, including general merchandise and food discount stores in the United States and integrated online business. - The Credit Card Segment offers credit to qualified guests through its branded credit cards, the Target Visa and the Target Card.",
		applylink: "bit.ly/VcBRDW",
		news: "",
	};
	...
	companiesData['TXN'] = {
		...
		id: "TXN",
		logo: "TXN.png",
		industries: "1930, Texas",
		founded: "Founded in Columbus, Ind., in 1919 as Cummins Engine Company",
		slogan: "\"None\"",
		facts: "- TI was the first semiconductor company to go global. - TI’s analog chips are used in electronics ranging from portable ultrasound equipment to set-top boxes, from eBooks to computer servers, and from robotics to LED streetlights. - TI connectivity chips power about 50 percent of all mobile phone Wi-Fi connections.",
		linkedin: "",
		twitterlink: "@TXInstruments",
		fblink: "on.fb.me/SbfqzX",
		rssfeed: "",
		lookfor: "Electrical Engineering, Computer Science, Computer Engineering",
		overview: "Texas Instruments develops analog, digital signal processing, RF and DLP® semiconductor technologies that help customers deliver consumer and industrial electronics products with greater performance, increased power efficiency, higher precision, more mobility and better quality.",
		mission: "- Use the company's unique technical skills to fundamentally change markets and create entirely new ones.- Drive innovation in product development,  work across organizational boundaries in the search for optimized solutions.- Maintain innovation within R&D by creating labs that  not only catalyze innovation throughout TI but also serve to attract top talent to TI, furthering our commitment to cultivating the next generation of engineers.  ",
		goals: "- High ethical standards - Respect for individuals - Concern for the environment - Commitment to the communities they live in ",
		businessModel: "The Company sells custom and catalog semiconductor products. Custom products are designed for a specific customer for a specific application, are sold only to that customer and are sold to the customer. The life cycles of custom products are determined by end-equipment upgrade cycles and can be as short as 12 to 24 months.",
		applylink: "N/A",
		news: "",
	};	
	...
	companiesData['TM'] = {
		...
		founded: "1937 in Toyota, Japan",
		slogan: "\"Moving Forward.\"",
		facts: "Designed the World’s first gas/electric hybrid: the Prius. - Toyota has been in the US since 1957. - Employs more than 365,000 around the World ",
		linkedin: "",
		twitterlink: "@Toyota",
		fblink: "fb.com/Toyota",
		rssfeed: "",
		lookfor: "Mechanical, Computer, Electrical Aerospace, Chemical, Materials, and Industrial",
		overview: "Toyota is a Japanese car manufacturer. Its operations extend throughout the whole World.  Toyota is one of the top-selling brands in America and their model Toyota Camry is the top selling mid-size car in the country. Another of its models, the Toyota Corolla is the best selling car in the World.",
		...
		goals: "Some of the company’s goals are: - To be the most successful and respected car company in America. - Promote the development of technologies to achieve best-in-class fuel efficiency performance - Introduce vehicle technologies, which support the diversification of energy and fuel sources - Promote the development of clean-energy vehicles and ensure wider market acceptance - Reduce waste and the need to recycle material throughout all operations and processes.",
		businessModel: "Toyota’s U.S. sales and marketing arm, oversees sales and other operations in 49 states. - Toyota regional offices coordinate Toyota and Scion vehicle sales, parts and service for dealers in ten regional areas, with two additional regions being served by private distributors. - The Lexus Division directs sales and operations for 229 Lexus dealers located throughout the U.S. through four area offices. TRD, U.S.A., a subsidiary of Toyota, designs, develops and assembles engines to drive Toyota's racing programs.",
		applylink: "toyota.com/about/careers/",
		news: "",
	};
	...
	companiesData['TURC'] = {
		...
		id: "TURC",
		logo: "TURC.png",
		industries: "Construction Management, General Contracting",
		founded: "1902: New York City",
		slogan: "\"Every worker goes home from each of our jobs, every day\"",
		facts: "-One of the largest construction management companies with an $8 billion construction net worth in 2011 - Constructed many sports stadiums today- Turner Construction has facilities in Australia and the United Kingdom",
		linkedin: "",
		twitterlink: "@TurnerNJ",
		fblink: "http://on.fb.me/pqYBxc",
		rssfeed: "",
		lookfor: "Civil, Mechanical, Industrial Engineers",
		overview: "The Turner Construction Company is a construction management company that \"provides building services to clients who value diligence, resourcefulness and creativity in a partner\".  They maintain a network of offices around the country and rank first or second on most industry major markets with an $8 billion in annual construction volume.",
		mission: "N/A",
		goals: "The company believes that a well-trained staff, striving to meet both personal and professional goals, is the heart of our company. With the company’s Development Appraisal System (D.A.S), Turner Consruction evaluates employee performance, listen to feedback and establish career goals and milestones together. Because the evaluation is also a conversation, the company is able to better structure an individual learning plan and assist Turner Construction’s employees to realize their maximum potential.",
		businessModel: "-Turner Construction won the Associated General Contractors of America’s Metropolitan award for work done with Inova Health and Washington Public schools -Turner has achieved a top-five ranking on the contractor’s lost every year since it was published in 1958 -http://bit.ly/OMnwcR",
		applylink: "http://bit.ly/X0FMpN",
		news: "",
	};
	...
	companiesData['UTX'] = {
		...
		founded: "1975 US",
		slogan: "\"UNT\"",
		facts: "- Headquartered in Connecticut -208,200 employees",
		linkedin: "",
		twitterlink: "N/A",
		fblink: "fb.com/ pages/United-Technologies/114800361868880",
		rssfeed: "",
		lookfor: "Aerospace, systems, and several other engineering fields.",
		overview: "United Technologies Corporation (UTC) is an American company that researches, develops, and manufactures high-technology products in numerous areas, including aircraft engines, helicopters, HVAC, fuel cells, elevators and escalators, fire and security, building systems, and industrial products, among others. UTC is also a large military contractor. Louis R. Chênevert is the current CEO.",
		mission: "Every day, in almost every country in the world, customers define our competitive excellence when they decide to buy our products and services or those of a competitor's. Similarly, investors define our competitive excellence when they choose to invest in us or in another company. Only by offering superior value to both customers and investors will our company continue to grow and prosper.",
		goals: "Committed to quality in all of their processes.",
		businessModel: "-A quality-first mindset governs all UTC employee actions. -External and internal customers receive innovative products and services that completely satisfy life cycle requirements. -Quality improvement is the job of every UTC employee.",
		applylink: "http://careers.utc.com/index.asp",
		news: "",
	};	
	...
	companiesData['USMC'] = {
		...
		id: "USMC",
		logo: "USMC.png",
		industries: "Military, National Defense",
		founded: "1775 in Tun Tavern",
		slogan: "\"The Few, the Proud\"",
		facts: "- Mascot is the English Bulldog - The marines Hymn is the oldest official song in the U.S. Armed Forces",
		linkedin: "",
		twitterlink: "@USMC",
		fblink: "http://www.facebook.com/marines",
		rssfeed: "",
		lookfor: "All engineering and will financially support your education",
		overview: "America’s force in readiness, have a demanding recruit training process, and have a commitment between Marine and Marine Corps expressed by their Motto: (always faithful).",
		mission: "Make Marines. Win our Nation’s Battles. Develop Quality Citizens. Values are Honor, Courage, Commitment ",
		goals: "- Use a rigorous 12 week training program. - Instill traits in marines that will allow them to become quality citizens. - Consider and incorporate family values and decisions. - Be deployed in land from a base/post in less than 6 hours.",
		businessModel: "- Will pay up to 100 percent of educational expenses under the Post 9-11 GI Bill and the Marine Corps College Fund. - Marine Corps Officers will have the chance to earn a Master’s Degree and law degrees under the Advanced Degree Program",
		applylink: "http://bitly.com/SZy0LX ",
		news: "",
	};
	...
	companiesData['USNRC'] = {
		...
		id: "USNRC",
		logo: "USNRC.png",
		industries: "Public sector, Nuclear energy",
		founded: "Washington D.C 1974",
		slogan: "\"Protecting people and the environment\"",
		facts: "-Currently Headquartered in Rockville, Maryland - The NRC is headed by five Commissioners appointed by the President of the United States - NRC expects to hire approximately 250 new staff this year (engineers)",
		linkedin: "",
		twitterlink: "http://bit.ly/VMfm6e",
		fblink: "N/A",
		rssfeed: "",
		lookfor: "Nuclear, Mechanical, Chemical, Structural, Electrical, Environmental, Materials, Software, and Human Factor engineers",
		overview: "The U.S. Nuclear Regulatory Commission (NRC) was created as an independent agency by Congress in 1974 to enable the nation to safely use radioactive materials for beneficial civilian purposes while ensuring that people and the environment are protected.",
		mission: "-To regulate the nation's civilian use of byproduct, source, and special nuclear materials -To ensure adequate protection of public health and safety -To promote the common defense and security -To protect the environment.  ",
		goals: "To coordinate with a wide array of Federal, State, local, and Tribal governments on matters related to nuclear material regulation, license renewal, and new reactor licensing, etc.",
		businessModel: "The NRC is headed by five Commissioners appointed by the President and confirmed by the Senate for five-year terms. One of them is designated by the President to be the Chairman and official spokesperson of the Commission.",
		applylink: "http://1.usa.gov/R6x5p5",
		news: "",
	};	
	...
	companiesData['VZ'] = {
		...
		logo: "VZ.png",
		industries: "Telecommunications",
		founded: "In 1983 as Bell Atlantic. June 30, 2000 in New York, New York became Verizon.",
		slogan: "\"We never stop working for you.\"",
		facts: "-Verizon was founded with the merger of Bell Atlantic Corp. and GTE Corp., Verizon network operates at speeds up to OC-192 (the fastest available).",
		linkedin: "",
		twitterlink: "@Verizon",
		fblink: "fb.com/Verizon",
		rssfeed: "",
		lookfor: "Mainly, Computer (Hardware and Software), Electrical, Materials, and Industrial Engineers but they welcome applicants from any field of engineering.",
		overview: "\"Verizon is a global leader in delivering innovative communications, information and entertainment. We offer voice, data and video products and services over intelligent wireless, broadband and global IP networks that meet customers' growing demand for speed, mobility, security and control.\" Cited from http://www22.verizon.com/about/",
		mission: "To be a leader in delivering broadband and other communication innovations to wireline and wireless customers",
		goals: "Provide the fastest, most secure, and reliable network of telecommunication for corporate clients and individual customers.",
		businessModel: "\"Get a phone line that's 99.9% reliable\". cited from www.verizonbusiness.com. Verizon focuses on providing reliable and easy-to-use communications service.",
		applylink: "http://www22.verizon.com/jobs/",
		news: "",
	};
	...
	companiesData['VBPH'] = {
		...
		slogan: "\"Growing a diverse workforce and a brighter future for our region.\"",
		facts: "- Work with a various companies in the Pittsburgh area -One of their sponsors is the Latin American Cultural union -The president is Jeffrey W. Spear.",
		linkedin: "",
		twitterlink: "http://bit.ly/VAIodG",
		fblink: "http://on.fb.me/Ui4mC8",
		rssfeed: "",
		lookfor: "All types of Engineers",
		overview: "Through collaboration with and support of human resource departments, corporate recruiters, professional organizations and non-profits, Vibrant Pittsburgh is committed to bringing the best talent on earth to Pittsburgh.",
		mission: "Vibrant Pittsburgh’s mission is embrace inclusion, ensure the Pittsburgh region’s growth by attracting, retaining and elevating a diversity of talent and promote the region nationally and internationally as a diverse, welcoming region of opportunities.",
		goals: "Vibrant Pittsburgh believes that a diverse workforce is essential to the ongoing economic vitality of the Greater Pittsburgh region. We must attract, retain, elevate and educate people of all backgrounds, including New Americans, and create an environment that is inclusive and welcoming.",
		businessModel: "Establish relationships with regional and national multicultural STEM-related student organizations, alumni associations, and diverse professional associations to foster awareness of regional job opportunities and talent attraction initiatives.",
		applylink: "http://bit.ly/SwjqtG",
		news: "",
	};	
	...
	companiesData['VW'] = {
		...
		founded: "1955: New York City, New York",
		slogan: "\"Quality, Innovation, Commitment at work in America.\"",
		facts: "- In 2009, Volkswagen Group of America was named a corporate leader in Strategic Vision, Inc.’s - Volkswagen Group is also member of the California Fuel Cell Partnership located in Sacramento. ",
		linkedin: "",
		twitterlink: "@VWGoA",
		fblink: "http://on.fb.me/U5sYYV",
		rssfeed: "",
		lookfor: "Fields include engineering, technical, and business (large variety).",
		overview: "Volkswagen opened its first U.S-based operation in New York City in 1955, eventually moving to Englewood Cliffs, NJ. While other automakers built even-larger cars, Volkswagen connected with passionate American consumers, delivering innovative, fun, and fuel-efficient vehicles. Within 10 years, sales skyrocketed and the company had more than 900 dealers across the United States. Today, the Volkswagen Group is the third-largest automaker in the world. Their operations include Audi, Bentley, Bugatti, Lamborghini and Volkswagen brands, as well as Volkswagen Group of America Chattanooga Operations and the related financial services of VW Credit, Inc.",
		mission: "To offer attractive, safe, and environmentally sound vehicles that are competitive in an increasingly tough market and that set world standards in their respective classes. According to the company, it’s really all about the American dream- turning challenges into opportunities. At Volkswagen group of America, they strive for the exceptional, and are committed to their continuing connection with American consumers, our communities and the environment.",
		goals: "Volkswagen Group of America’s goal is inspiring passion in one million new Volkswagen and Audi drivers each year in the United States by 2018",
		businessModel: "He Volkswagen Group practices a no-corruption system called the Ombudsman System that creates an environment within which employees and buisness partners can help fight corruption. Corruption is not a trivial offense: on the contrary, it harms the company and its employees. This is why uncovering corruption is so important.",
		applylink: "http://bit.ly/fGy72q",
		news: "",
	};	
	...
	companiesData['WEST'] = {
		...
		id: "WEST",
		logo: "WEST.png",
		industries: "Nuclear electric power",
		founded: "In 1886",
		slogan: "\"Providing safe, clean, reliable energy\"",
		facts: "Nearly 50 percent of the nuclear power plants in operation worldwide, and nearly 60 percent in the United States, are based on Westinghouse technology.",
		linkedin: "",
		twitterlink: "N/A",
		fblink: "N/A",
		rssfeed: "",
		lookfor: "Nuclear, Electrical, Mechanical, Chemical, Civil, Materials, Computer and Industrial Engineers.",
		overview: "\"Westinghouse Electric Company provides fuel, services, technology, plant design, and equipment to utility and industrial customers in the worldwide commercial nuclear electric power industry.\"",
		mission: "\"…to be the customers' choice to supply leading-edge nuclear technology to satisfy the world's growing demand for energy.\"",
		goals: "- To increase safety, reliability, efficiency, and life extension of operating plants. - To solve the nuclear industry's current and emerging technical challenges. - To develop advanced new plants and revolutionary fuel cycle approaches. - To strengthen 'nuclear' as the environmental energy choice.",
		businessModel: "- Acting with integrity and respect for others. - Being safe and environmentally responsible. - Committing to achieving success for customers. - Delivering value and profit. - Excelling in all company operations.",
		applylink: "http://bit.ly/Qvn4oA",
		news: "",
	};
	...
	companiesData['WWD'] = {
		...
		founded: "1870: Rockford, Illinois.",
		slogan: "\"Always Innovating for a Better Future\"",
		facts: "- In 2007, Woodward became a $1 billion company. - Operating in approximately 14 countries. - In 2011, the company change name to Woodward, Inc.",
		linkedin: "",
		twitterlink: "N/A",
		fblink: "N/A",
		rssfeed: "",
		lookfor: "Chemical, Electrical, Industrial, Materials Science & Mechanical Engineers",
		overview: "Woodward, Inc. is an independent designer, manufacturer, and service provider of control solutions for the aerospace and energy markets.",
		mission: "We have a clear vision and follow carefully planned long-term strategies. With multiple locations in fourteen countries, Woodward can respond quickly with solutions tailored to the local demands of our customers.",
		goals: "At Woodward Inc, we believe in A Tradition of Integrity. These core values and principles are essential to us, and we expect everyone at Woodward to behave accordingly. Within the Woodward Codes of Business Conduct and Ethics there are two codes: - The Woodward Code of Business Conduct and - The Woodward Code of Ethics for Senior Financial Officers and Other Finance Members. The Woodward Code of Business Conduct applies to all Woodward members as well as to Woodward's directors",
		businessModel: "Within the aerospace market, we provide systems, components and solutions for both commercial and military applications. Our key focus areas within this market are: Propultion systems and motion control solutions. Within the energy market, our key focus areas are: control solution for equipments, control of power quality, distribution and conservation of reusable.",
		applylink: "http://www.woodward.com/interngradopportunities.aspx",
		news: "",
	};	
